<?php
    ...
    if(isset($_POST['submit'])){
        $res = $staff->addDrug($_POST['name'], $_POST['qty']);
                                ...
                                <div class="card-body">
                                    <div class="col-md-6 mx-auto mt-4">
                                        <form action="#" method="POST" class="mx-auto">
                                            <div class="row mb-3">
                                                <label for="" class="col-sm-3 ms-2 col-form-label">Name</label>
                                                <div class="col-sm-7">
                                            ...
                                            <div class="row mb-3">
                                                <label for="" class="col-sm-3 ms-2 col-form-label">Quantity</label>
                                                <div class="col-sm-7">
